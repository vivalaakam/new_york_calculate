...
mod tests {
    ...
    async fn test_perform_candles_without_indicators() {
        ...
        assert_eq!(
            format!("{:?}", candles[0]),
            r#"Candle { start_time: 1655769600, open: 0.3226, high: 0.3232, low: 0.3217, close: 0.3223, volume: 1047813.0, quote: 337795.6648, trades: 491.0, buy_base: 502532.0, buy_quote: 161987.0611, history: [], shape: [12, 0], max_profit: [0.7439553626782391, 1.332920024798523, 1.7668939863608069, 2.9758214507129566, 4.587724736515808], max_profit_1: 0.7439553626782391, max_profit_3: 1.332920024798523, max_profit_6: 1.7668939863608069, max_profit_12: 2.9758214507129566, max_profit_24: 4.587724736515808, score: 0.0 }"#
        );
