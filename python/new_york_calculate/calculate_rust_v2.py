from .new_york_calculate import PyCalculateV2


class CalculateRustV2:
    def __init__(self, intraday_results, initial_balance=3000, stake=10, gain=1.0, profit=0.5):
        self.instance = PyCalculateV2(candles=intraday_results, initial_balance=initial_balance, stake=stake, gain=gain,
                                      profit=profit)
